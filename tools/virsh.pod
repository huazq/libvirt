...
[I<auto-converge-increment>] [I<--persistent-xml> B<file>] [I<--tls>] [I<--colo>]
...
and target.I<--colo> enable colo feature of migration,which turn migration 
into vm fault tolerence
